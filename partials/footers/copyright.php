					...
					<div class="clearfix">
						...
						<?php if($footer_copyright_text): ?>
							<div class="copyright_text">
								...
								<p style="font-size: 12px; margin-bottom: 5px !important;"><?php the_field( 'name_footer_ru', 'option' ); ?></p>
								<p style="font-size: 12px; margin-bottom: 5px !important;"><a href="<?php the_field( 'link_conf_ru', 'option' ); ?>"><?php the_field( 'conf_title_ru', 'option' ); ?></a></p>
								<p style="font-size: 12px; margin-bottom: 5px !important;"><a href="<?php the_field( 'link_doc_oferta_ru', 'option' ); ?>"><?php the_field( 'doc_offerta_ru', 'option' ); ?></a></p>
								<p style="font-size: 12px; margin-bottom: 5px !important;"><a href="<?php the_field( 'literatura_link', 'option' ); ?>"><?php the_field( 'literatura', 'option' ); ?></a></p>
